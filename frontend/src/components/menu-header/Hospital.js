...
import HospitalData from "./service/HospitalData";
function Services() {
  //default true show Hospital other false since main route is services
  const [isShowHospital, setShowHospital] = useState(true);
